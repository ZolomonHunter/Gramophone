        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbomId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubscribedPlaylistsId = table.Column<int>(type: "int", nullable: false),
                    SubscribersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListenerPlaylist", x => new { x.SubscribedPlaylistsId, x.SubscribersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SubscribedPlaylistsId,
